...
@Component({
  selector: 'app-cal-ubs-add-edit-agreement',
  templateUrl: './cal-ubs-add-edit-agreement.component.html',
  styleUrls: ['./cal-ubs-add-edit-agreement.component.scss']
})
export class CalUbsAddEditAgreementComponent implements OnInit {
