...
@Component({
  selector: 'app-cal-ubs-add-edit-centertype',
  templateUrl: './cal-ubs-add-edit-centertype.component.html',
  styleUrls: ['./cal-ubs-add-edit-centertype.component.scss']
})
export class CalUbsAddEditCentertypeComponent implements OnInit {
...
Addcenter() {
  ...
  this.service.AddCenterType(this.centid,this.UserId,data).subscribe((res) => {
   ...
   this.router.navigate(['/CAL-UBS-Add-Update-OtherInfo',this.centid]);
