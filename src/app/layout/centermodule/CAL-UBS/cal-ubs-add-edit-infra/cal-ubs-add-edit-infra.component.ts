...
@Component({
  selector: 'app-cal-ubs-add-edit-infra',
  templateUrl: './cal-ubs-add-edit-infra.component.html',
  styleUrls: ['./cal-ubs-add-edit-infra.component.scss']
})
export class CalUbsAddEditInfraComponent implements OnInit {
