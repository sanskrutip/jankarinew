...
@Component({
  selector: 'app-idi-add-edit-infra-details',
  templateUrl: './idi-add-edit-infra-details.component.html',
  styleUrls: ['./idi-add-edit-infra-details.component.scss']
})
export class IdiAddEditInfraDetailsComponent implements OnInit {
...
Skip(){
  this.router.navigate(['/IDICenterPartnerDetails', this.centid]);
}
