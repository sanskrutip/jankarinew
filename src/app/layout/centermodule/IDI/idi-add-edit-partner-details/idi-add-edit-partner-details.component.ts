...
@Component({
  selector: 'app-idi-add-edit-partner-details',
  templateUrl: './idi-add-edit-partner-details.component.html',
  styleUrls: ['./idi-add-edit-partner-details.component.scss']
})
export class IdiAddEditPartnerDetailsComponent implements OnInit {
