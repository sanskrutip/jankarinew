...
@Component({
  selector: 'app-idi-computer-hardware',
  templateUrl: './idi-computer-hardware.component.html',
  styleUrls: ['./idi-computer-hardware.component.scss']
})
export class IdiComputerHardwareComponent implements OnInit {
