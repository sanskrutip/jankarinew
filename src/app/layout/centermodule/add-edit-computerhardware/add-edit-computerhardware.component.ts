...
@Component({
  selector: 'app-add-edit-computerhardware',
  templateUrl: './add-edit-computerhardware.component.html',
  styleUrls: ['./add-edit-computerhardware.component.scss']
})
export class AddEditComputerhardwareComponent implements OnInit {
  CenterId;
  UserId;
  ComputerList;
