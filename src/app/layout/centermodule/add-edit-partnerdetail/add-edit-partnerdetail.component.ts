...
@Component({
  selector: 'app-add-edit-partnerdetail',
  templateUrl: './add-edit-partnerdetail.component.html',
  styleUrls: ['./add-edit-partnerdetail.component.scss']
})
export class AddEditPartnerdetailComponent implements OnInit {
  CenterId;
  UserId;
  CenterPartner;
