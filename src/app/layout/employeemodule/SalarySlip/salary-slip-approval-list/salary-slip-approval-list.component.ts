...
@Component({
  selector: 'app-salary-slip-approval-list',
  templateUrl: './salary-slip-approval-list.component.html',
  styleUrls: ['./salary-slip-approval-list.component.scss']
})
export class SalarySlipApprovalListComponent implements OnInit {
 ...
 console.log("1finala where"+    this.strwhr)
  ...
  filterrecord() {
    ...
    if (this.searchstate != null && this.searchstate != "" && this.searchstate != "undefined" && this.searchstate != "Select") {
      this.array.push("Employee.state='" + this.searchstate + "'");
    }

    if (this.searchcity != null && this.searchcity != "" && this.searchcity != "undefined" && this.searchcity != "Select") {
      this.array.push("Employee.city='" + this.searchcity + "'");
    }
